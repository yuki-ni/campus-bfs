const graph = {
  ...
  "Admin Building":      ["Gate 1", "Gate 2", "Promenade", "Elementary Building"],
  "Anatomy":             ["Fine Arts"],
  "Ancheta Hall":        ["Weston Hall", "Johnson Hall", "Elementary Building"],
  "Big Field":           ["Promenade", "LDT Building", "Henry Luce", "RMA", "University Church", "Franklin Hall", "Engineering Building", "Weston Hall", "Roblee"],
  "CHM":                 ["Gate 6", "Johnson Hall", "Elementary Field"],
  "Elementary Building": ["Gate 1", "Admin Building", "Elementary Gym", "Promenade", "Weston Hall", "Ancheta Hall"],
  "Elementary Field":    ["Elementary Gym", "Gate 6", "CHM"],
  "Elementary Gym":      ["Elementary Building", "Elementary Field", "Johnson Hall"],
  ...
  "Johnson Hall":        ["CHM", "Ancheta Hall", "Elementary Gym"],
  ...
  "Swimming Pool":       ["Henry Luce", "Softball Field", "Tennis Court"],
...
const drivingGraph = {
  ...
  "Elementary Field": ["Elementary Gym", "CHM"],
  "Elementary Gym":  ["Elementary Building", "Johnson Hall"],
  "Engineering Building": ["University Church"],
  "Fine Arts":       ["Gate 7", "University Gym", "Anatomy"],
  "Franklin Hall":  ["Engineering Building"],
  "Henry Luce":     ["LDT Building", "RMA", "Swimming Pool"],
  ...
  "Mary Thomas":    ["Old Valentine"],
  "New Valentine":  ["Roblee", "Old Valentine"],
  "Old Valentine":  ["New Valentine", "Mary Thomas"],
  "PKGE":           ["Engineering Building", "Franklin Hall"],
  "Promenade":      ["New Valentine"],
  "RMA":            ["Henry Luce", "University Gym", "University Church", "Kindergarten", "Tennis Court"],
  "Roblee":         ["Franklin Hall", "UY Building", "New Valentine", "Lopez Hall"],
  "Senior High Building": ["LEB", "HS Gym"],
  "Softball Field": ["Swimming Pool"],
  "Swimming Pool":  ["Henry Luce", "Softball Field"],
...
const DRIVING_FILTERS = {
  start: n => !["Gate 1", "Gate 3", "Gate 5", "Gate 7"].includes(n),
...
function findPath() {
  ...
  if (travelMode === "driving") {
    if (isGate(start) && !["Gate 2", "Gate 4", "Gate 6", "Gate 8"].includes(start)) {
      showMsg("⚠️ Cars must enter through Gate 2, Gate 4, Gate 6, or Gate 8.");
